...
export class RelanceSidebarThin extends LitElement {
  ...
  render() {
    ...
    return html`
      <div class="fixed top-0 left-[40px] z-30 w-[200px] h-screen bg-gray-50 border-r border-gray-200 py-4 transition-all duration-300 ease-in-out">
        ...
        <nav class="space-y-1">
          <a 
            href="/app/relances/"
            class="block px-4 py-2 text-sm text-gray-600 hover:bg-gray-100 hover:text-gray-900 rounded-r-lg transition-colors duration-200"
          >
            Dashboard
          </a>
